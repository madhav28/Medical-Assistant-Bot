...
# Currently using base model (commented out line would load the fine-tuned PEFT model)
model = base_model
...
df.to_csv("../data/mle_screening_test_dataset_base_prediction.csv", index=False)